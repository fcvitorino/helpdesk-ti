    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0"><i class="bi bi-building"></i> Nova Empresa</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.companies.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('cnpj') is-invalid @enderror" 
                               id="cnpj" name="cnpj" value="{{ old('cnpj') }}" placeholder="00.000.000/0000-00" required>
                        @error('cnpj')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('ramo') is-invalid @enderror" 
                               id="ramo" name="ramo" value="{{ old('ramo') }}">
                        @error('ramo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
