...
<div class="card">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('admin.companies.create')); ?>" class="btn btn-light">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.companies.show', $company)); ?>" class="btn btn-sm btn-info">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="<?php echo e(route('admin.companies.edit', $company)); ?>" class="btn btn-sm btn-warning">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form action="<?php echo e(route('admin.companies.destroy', $company)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\helpdesk\resources\views/admin/companies/index.blade.php ENDPATH**/ ?>