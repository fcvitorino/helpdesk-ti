...
<div class="container-fluid">
        ...
        <div class="col-md-3">
            <div class="card text-white bg-primary mb-3">
                <div class="card-body">
                    ...
                    <h2 class="card-text"><?php echo e($totalTickets ?? 0); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card text-white bg-warning mb-3">
                <div class="card-body">
                    ...
                    <h2 class="card-text"><?php echo e($ticketsAberto ?? 0); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card text-white bg-info mb-3">
                <div class="card-body">
                    ...
                    <h2 class="card-text"><?php echo e($ticketsEmAndamento ?? 0); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card text-white bg-success mb-3">
                <div class="card-body">
                    ...
                    <h2 class="card-text"><?php echo e($ticketsResolvido ?? 0); ?></h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showSectorChart): ?>
        <div class="col-md-6">
            <div class="card mb-3">
...
<script>
    <?php if($showSectorChart): ?>
    // Gráfico por Setor (apenas para Admin/Técnico)
    const ctxSetor = document.getElementById('chartSetor').getContext('2d');
    new Chart(ctxSetor, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($ticketsPorSetor->pluck('name')); ?>,
            datasets: [{
                label: 'Quantidade',
                data: <?php echo json_encode($ticketsPorSetor->pluck('total')); ?>,
    ...
    new Chart(ctxPrioridade, {
        type: 'pie',
        data: {
            labels: <?php echo json_encode($ticketsPorPrioridade->pluck('priority')); ?>,
            datasets: [{
                data: <?php echo json_encode($ticketsPorPrioridade->pluck('total')); ?>,
    ...
    new Chart(ctxLocal, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($ticketsPorLocal->pluck('location')); ?>,
            datasets: [{
                label: 'Quantidade',
                data: <?php echo json_encode($ticketsPorLocal->pluck('total')); ?>,
    ...
    new Chart(ctxMes, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($ticketsPorMes->pluck('month')); ?>,
            datasets: [{
                label: 'Quantidade',
                data: <?php echo json_encode($ticketsPorMes->pluck('total')); ?>,
